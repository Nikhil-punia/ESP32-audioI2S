...
void Audio::processLocalFile() {
    ...
    // AUDIO_LOG_ERROR("byteCounter %u >= m_audioDataSize %u, m_f_allDataReceived % i", byteCounter, m_audioDataSize, m_f_allDataReceived);
...
noSuccess:
    m_stsz_numEntries = 0;
    m_stsz_position = 0;
    AUDIO_LOG_ERROR("m4a atom stsz not found");
    m_audiofile.seek(0);
    return;
}
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
